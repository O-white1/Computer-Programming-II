...
class Neptune(Form):
	...
	def InitializeComponent(self):
		...
		self.ClientSize = System.Drawing.Size(274, 226)
	...
	def Button1Click(self, sender, e):
		...
		self.label2.Text = "Average distance from the sun:  30.0611 AU"
		self.label3.Text = "Mass:  1.03 × 1026 kg"
		self.label4.Text = "Surface Tempurature:  –216°C"